...
class InjectContainerImpl extends InjContainer {}

abstract class InjContainer {
  T call<T>() {
  ...
  void create<S>(InstanceBuilderCallback<S> builder,
    ...
    _instance.create<S>(builder, tag: tag, permanent: permanent);
  }

  bool delete<S>({String? tag, String? key, bool force = false}) {
    return _instance.delete<S>(tag: tag, key: key, force: force);
  }
  ...
  void lazyPut<S>(InstanceBuilderCallback<S> builder,
    ...
    _instance.lazyPut<S>(builder, tag: tag, fenix: fenix, permanent: permanent);
  }
  ...
  S put<S>(S dependency, {String? tag, bool permanent = false}) {
    return _instance.put<S>(dependency, tag: tag, permanent: permanent);
  }

  Future<S> putAsync<S>(AsyncInstanceBuilderCallback<S> builder,
      {String? tag, bool permanent = false}) {
    return _instance.putAsync<S>(builder, tag: tag, permanent: permanent);
  }
